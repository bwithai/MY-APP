var DashboardApp = {
    ...
    initializeEarlyChart: function() {
        ...
        // Check that EarlyChart component is available
    ...
    preloadChartJs: function() {
        // First check if Chart.js is already defined
        ...
        if (document.getElementById('chart-script')) {
            console.log('Chart.js loading already attempted');
            return;
        }

        console.log('Loading Chart.js');

        // Create script elements for Chart.js
        var chartScript = document.createElement('script');
        chartScript.id = 'chart-script';
        chartScript.src = 'js/lib/chart.js@2.9.4';
        ...
        function checkScriptsLoaded() {
            if (typeof Chart !== 'undefined') {
                ...
                // Initialize chart components here
            }
        }

        chartScript.onload = checkScriptsLoaded;
