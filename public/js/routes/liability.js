var LiabilityApp = {
    ...
    renderLiabilityTable: function(liabilities) {
        ...
        liabilities.forEach(function(liability) {
            ...
            row.innerHTML = 
                '<td>' + (liability.head || 'N/A') + '</td>' +
                '<td>' + (liability.sub_heads || 'N/A') + '</td>' +
                '<td class="long-text ' + (liability.fund_details ? '' : 'text-muted') + '">' +
                    ...
                    '</div>' +
                '</td>' +
                '<td title="' + (liability.amount || 0) + '">' + Utils.formatNumber(liability.amount) + '</td>' +
                '<td title="' + (liability.remaining_balance || 0) + '">' + Utils.formatNumber(liability.remaining_balance) + '</td>' +
